...
@Predictor.register("trip-sentence-tagger")
class TripSentenceTaggerPredictor(Predictor):
    """
    ...
    def predict(self, sentence1: str,sentence2: str, sentence3: str ) -> JsonDict:
        return self.predict_json({"sentence1": sentence1,"sentence2": sentence2,"sentence3": sentence3})
    ...
    def _json_to_instance(self, json_dict: JsonDict) -> Instance:
        ...
        sentence3 = json_dict["sentence3"]
        tokens = self._tokenizer.tokenize(sentence1)
        tokens3 = self._tokenizer.tokenize(sentence3)
        return self._dataset_reader.text_to_instance(tokens, tokens3)
