...
@DatasetReader.register("wnut16_adv_3ways")
class WNUT16Adv3WaysDatasetReader(DatasetReader):
    """
        ...
        with open(file_path, "r") as data_file:
            ...
            for is_divider, lines in itertools.groupby(data_file, _is_divider):
                ...
                if not is_divider:
                    ...
                    yield self.text_to_instance(tokens, adv_tokens, neg_tokens , ner_tags,adv_tags)
