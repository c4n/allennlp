...
@TrainerBase.register("adversarial_trainer_2inputs", constructor="from_partial_objects")
class AdversarialTrainer2Inputs(TrainerBase):
    def __init__(
        self,
        model: Model,
...
#             self.train_data=self.dataset_reader.read('/home/datamind/can/FinalProject/allennlp_tutorial/data/train.txt')
            self.train_data=self.dataset_reader.read(self.train_data_path)
            self.train_data.index_with(self.model.vocab)
