...
@DatasetReader.register("conll2003_adv")
class Conll2003AdvDatasetReader(DatasetReader):
    """
        ...
        with open(file_path, "r") as data_file:
            ...
            for is_divider, lines in itertools.groupby(data_file, _is_divider):
                ...
                if not is_divider:
                    ...
                    adv_tags = ['clean'] * len(tokens)
                    yield self.text_to_instance(tokens, pos_tags, chunk_tags, ner_tags,adv_tags)
