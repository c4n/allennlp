...
@DatasetReader.register("conll2003_adv_2ways")
class Conll2003Adv2WaysDatasetReader(DatasetReader):
    """
        ...
        with open(file_path, "r") as data_file:
            ...
            for is_divider, lines in itertools.groupby(data_file, _is_divider):
                ...
                if not is_divider:
                    ...
                    yield self.text_to_instance(tokens,adv_tokens, pos_tags, chunk_tags, ner_tags,adv_tags)
